...
{
    public struct ComfortZoneRoomTempChanged
    {
        ...
        public static ComfortZoneRoomTempChanged Create(string czName, double value)
        {
            return new ComfortZoneRoomTempChanged()
            {
                Target = JKeys.ComfortZone.TargetName,
                Action = JKeys.Action.Info,
                Name = czName,
                Value = value,
                Content = JKeys.ComfortZone.CurrentRoomTemp
            };
        }
    }
}
